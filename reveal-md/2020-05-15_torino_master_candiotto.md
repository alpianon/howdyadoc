...
- <!--frag fade-in-then-semi-out --> Background: i dati chiusi *by default*
- <!--frag fade-in-then-semi-out --> Perché chiudere i dati, perché aprirli
- <!--frag fade-in-then-semi-out --> I dati aperti: "open by default"
- <!--frag fade-in-then-semi-out --> Limiti
- <!--frag fade-in-then-semi-out --> Licenze
- <!--frag fade-in --> Oltre le licenze
...
- <!--frag fade-in-then-semi-out--> una licenza non è strettamente necessaria
- <!--frag fade-in-then-semi-out--> meglio nessuna licenza che una **sbagliata**
- <!--frag fade-in--> le licenze copyleft o *share alike* non sono una buona idea
...
1. <!--frag--> Tabella @fa[arrow-right fa-green] aggiunta di righe
2. <!--frag--> Tabella @fa[arrow-right fa-green] aggiunta di colonne
3. <!--frag--> Tabella @fa[arrow-right fa-red] @fa[link] tabella separata
4. <!--frag--> Tabella @fa[arrow-right fa-red] @fa[link] tabella pivot @fa[arrow-right fa-red] @fa[link] tabella separata
5. <!--frag--> Mappa @fa[arrow-right fa-red] overlay
6. <!--frag index:5--> Tabella @fa[arrow-right fa-green] aggregazione
7. <!--frag index:5--> Tabella @fa[arrow-right fa-red] aggregazione e trasformazione
...
**«** <!--frag index 1--> [la CC0] offre ai riutilizzatori una flessibilità totale e riduce le complicazioni collegate all’operatività su varie e diverse licenze con il potenziale conflitto di disposizioni che comporta.

Si raccomanda di prevedere, compatibilmente con il diritto applicabile, obblighi di minima imponendo **tutt’al più**: a) una frase che identifica la fonte del documento; b) un collegamento alle pertinenti informazioni sulla licenza (ove fattibile).**»**  <!--frag index 1 -->

**Comunicazione 2014/C – 240/01**  <!--frag index 1-->

---

## Svantaggi CC0

- <!--frag index="1"-->FUD da linee guida
- <!--frag index="1"-->Incompatibile se applicata a dati sotto altre licenze
